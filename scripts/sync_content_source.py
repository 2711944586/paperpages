...
SOURCE_PAPER = WORKSPACE_ROOT / "paper_ipm_main.md"
...
TARGET_PAPER_DIR = CONTENT_ROOT / "paper"
...
def main() -> None:
    ...
    sync_file(SOURCE_PAPER, TARGET_PAPER_DIR / SOURCE_PAPER.name)
    ...
    print(f"[OK] Synced paper source -> {TARGET_PAPER_DIR}")
